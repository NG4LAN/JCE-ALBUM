...
class Router
{
    ...
    public static function init()
    {
        ...
        Router::add('/', fn() => (new AlbumController())->index());
        Router::add('/album/create', fn() => (new AlbumController())->create(), 'POST');
        Router::add('/album/update/{id}', fn($data) => (new AlbumController())->edit($data['id']), 'GET');
        Router::add('/album/update', fn() => (new AlbumController())->update(), 'POST');
        Router::add('/album/delete/{id}', fn($data) => (new AlbumController())->delete($data['id']));
