...
<main>
    <section class="py-5 text-center container">
        <div class="row py-lg-5">
            <div class="col-lg-6 col-md-8 mx-auto">
                ...
                <p> <button class="btn btn-primary my-2">Add Memory</button> </p>
            </div>
        </div>
    </section>
    ...
    <section class="container">
        <form action="/album/update" method="POST" class="mb-3" enctype="multipart/form-data">
            <input type="hidden" name="id" value="<?= htmlspecialchars($album['id']) ?>">
            <input type="file" class="form-control" name="image" accept="image/*" required="">
            <input type="text" name="desc" class="form-control" value="<?= htmlspecialchars($album['description']) ?>" required>
            <button type="submit" class="btn btn-success mt-2 w-100">Update Content</button>
        </form>
    </section>
</main>
<?php
